...
p  = (1+rho)/2; 
% the rho is actually intuitively linked to the MC: 
% high autocorrelation means high chances of staying in the same state, 
% whether there is a shock or not
% less true with lower autocorrelation
PI = [p 1-p; 1-p p];
